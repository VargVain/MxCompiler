// Generated from //wsl$/Ubuntu/home/duang2000/java/Mx-Complier/src/antlr\MxParser.g4 by ANTLR 4.12.0
package antlr;
...
public class MxParser extends Parser {
	...
	public static final int
		...
		RightBrace=23, Question=24, Colon=25, Semi=26, Comma=27, OpLt=28, OpLeq=29, 
		OpGt=30, OpGeq=31, OpShl=32, OpShr=33, OpAdd=34, OpSub=35, OpMul=36, OpDiv=37, 
		OpMod=38, OpIncre=39, OpDecre=40, OpAnd=41, OpOr=42, OpAndAnd=43, OpOrOr=44, 
		OpCaret=45, OpNot=46, OpTilde=47, OpEq=48, OpNeq=49, OpAssign=50, OpMemberAccess=51, 
		Identifier=52, LogicalLiteral=53, IntegerLiteral=54, StringLiteral=55, 
		NullLiteral=56, Whitespace=57, Newline=58, BlockComment=59, LineComment=60;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"RightBrace", "Question", "Colon", "Semi", "Comma", "OpLt", "OpLeq", 
			"OpGt", "OpGeq", "OpShl", "OpShr", "OpAdd", "OpSub", "OpMul", "OpDiv", 
			"OpMod", "OpIncre", "OpDecre", "OpAnd", "OpOr", "OpAndAnd", "OpOrOr", 
			"OpCaret", "OpNot", "OpTilde", "OpEq", "OpNeq", "OpAssign", "OpMemberAccess", 
			"Identifier", "LogicalLiteral", "IntegerLiteral", "StringLiteral", "NullLiteral", 
	...
	public final SuiteContext suite() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 58759602267221948L) != 0)) {
				{
				{
				setState(87);
				statement();
	...
	public final ForStmtContext forStmt() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 58759602195662752L) != 0)) {
				{
				setState(177);
				expr(0);
				}
	...
	public static class UnaryExprContext extends ExprContext {
		...
		public TerminalNode OpTilde() { return getToken(MxParser.OpTilde, 0); }
	...
	public static class CondExprContext extends ExprContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MxParserListener ) ((MxParserListener)listener).enterCondExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MxParserListener ) ((MxParserListener)listener).exitCondExpr(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MxParserVisitor ) return ((MxParserVisitor<? extends T>)visitor).visitCondExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	...
	public static class BinaryExprContext extends ExprContext {
		...
		public TerminalNode OpCaret() { return getToken(MxParser.OpCaret, 0); }
		public TerminalNode OpOr() { return getToken(MxParser.OpOr, 0); }
		public TerminalNode OpAndAnd() { return getToken(MxParser.OpAndAnd, 0); }
		public TerminalNode OpOrOr() { return getToken(MxParser.OpOrOr, 0); }
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case OpTilde:
				...
				_la = _input.LA(1);
				if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 211157772140544L) != 0)) ) {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 7:
						...
						setState(247);
						((BinaryExprContext)_localctx).op = match(OpCaret);
						setState(248);
						expr(8);
						}
						break;
					...
					case 9:
						...
						setState(253);
						((BinaryExprContext)_localctx).op = match(OpAndAnd);
						setState(254);
						expr(6);
						}
						break;
					case 10:
						...
						setState(256);
						((BinaryExprContext)_localctx).op = match(OpOrOr);
						setState(257);
						expr(5);
						}
						break;
					case 11:
						...
						setState(259);
						((AssignExprContext)_localctx).op = match(OpAssign);
						setState(260);
						expr(3);
						}
						break;
					case 12:
						...
						setState(262);
						((CondExprContext)_localctx).op = match(Question);
						setState(263);
						expr(0);
						setState(264);
						((CondExprContext)_localctx).op = match(Colon);
						setState(265);
						expr(2);
						}
						break;
	...
	public final PrimaryContext primary() throws RecognitionException {
		...
		try {
			...
			setState(294);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 58546795155818368L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
